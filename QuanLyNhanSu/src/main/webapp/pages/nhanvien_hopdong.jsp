								...
								<tbody>
									<c:forEach var="hopdong" items="${listHopDong}">
										<tr>
											...
											<td><a
												href="<%=duongDanHopDong %>/hopdongcontrol?action=delete&mahd=<c:out value='${hopdong.maHD}'/>&mahs=<c:out value='${hopdong.maHS}'/>">Xóa</a>
										</tr>
									</c:forEach>
								</tbody>
							</table>
					...
					<div class="row gx-3 mb-3">
						...
						<div class="d-flex px-3 justify-content-end">
							<a
								...
								class="fal fa-sub-item-icon"></i> Hoàn tất hợp đồng -> Quá trình
								công tác
							</a>
						</div>
					</div>
